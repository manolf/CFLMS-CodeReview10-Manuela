...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2020 at 09:38 PM
...
CREATE TABLE `medium` (
  ...
  `genre` enum('Novel','Thriller','Guidebook','Sciene Fiction','Drama','Esoterism','Crime Storie','Manual','Biography','Children','Horror') DEFAULT 'Novel',
...
(97859681176, 'https://assets.thalia.media/img/artikel/5a014a4026ae1d109fd216b62e5d734844dde3ff-00-00.jpeg', 'Grossartiger Wohlfuehl-Grusel mit Lachgarantie Kommst du mit auf die Burg zu Grottenow? Dort lebt, zusammengeschustert und zum Leben erweckt von einem verrueckten Professor, der kleine Stichkopf. Stichkopf ist das treuste Geschoepf, das man sich vorstellen kann. In dieser Geschichte wird er einem Betrueger entkommen, wahre Freundschaft finden und das Abenteuer seines Lebens bestehen. Mit grossem Einfuehlungsvermoegen gelingt es Guy Bass, eine wunderbare Gruselgeschichte erzaehlen, ohne jemals seine Zielgruppe aus den Augen zu verlieren: kindgerecht und voller Humor. Jede Seite ein kleines Kunstwerk – liebevoll gestaltet von Pete Williamson Ein wahrhaft zauberhaftes Gruselbuch. ', 'book', '2015-09-24', 11, 11, 'available', 'Children', 'Stichkopf und das Scheusal'),
(4006680064994, 'https://assets.thalia.media/img/artikel/191409c93d3e7592019c7a3adfc45e593104520d-00-00.jpeg', 'Nosferatu the Vampyre is a 1979 horror film written and directed by Werner Herzog. Its original German title is Nosferatu: Phantom der Nacht (Nosferatu: Phantom of the Night). The film is set primarily in 19th-century Wismar, Germany and Transylvania, and was conceived as a stylistic remake of F. W. Murnaus 1922 German Dracula adaptation Nosferatu. The picture stars Klaus Kinski as Count Dracula, Isabelle Adjani as Lucy Harker, Bruno Ganz as Jonathan Harker, and French artist-writer Roland Topor as Renfield. There are two different versions of the film, one in which the actors speak English, and one in which they speak German.', 'dvd', '1978-01-07', 9, 9, 'available', 'Horror', 'Nosferatu'),
...
(81400079223467, 'https://assets.thalia.media/img/artikel/e629a446785cb6efcf8859ccebd66d03094bb4f9-00-00.jpeg', 'In London, Maya, a young woman trained to fight by her powerful father, uses the latest technology to elude detection when walking past the thousands of surveillance cameras that watch the city. In New York, a secret shadow organization uses a victims own GPS to hunt him down and kill him. In Los Angeles, Gabriel, a motorcycle messenger with a haunted past, takes pains to live ', 'book', '2006-05-01', 8, 2, 'available', 'Sciene Fiction', 'The Traveller'),
